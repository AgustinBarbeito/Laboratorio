...
public class Hotel {
    ...
    public ArrayList<Huesped> masFrecuentes(){
        ArrayList<Huesped> frecuentes= new ArrayList<>();
        ArrayList<Huesped> huespedes = (ArrayList<Huesped>) this.Huesped.clone();
        int i=0;
        while(i<2){
    ...
    public ArrayList<Habitacion> masSolicitadas(){
        ArrayList<Habitacion> habitaciones= this.Habitaciones;
        ...
        return habitacionesMasSolicitadas;
    }
